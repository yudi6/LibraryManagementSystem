...
class Ui_win_jinhuo(object):
    def setupUi(self, win_jinhuo):
        ...
        self.input_win_name.setGeometry(QtCore.QRect(350, 60, 311, 31))
        font = QtGui.QFont()
        ...
        self.book_name_btn.setGeometry(QtCore.QRect(350, 100, 311, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.hint_jin_huo_table.setGeometry(QtCore.QRect(470, 130, 81, 61))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
        ...
        self.jin_huo_btn.setGeometry(QtCore.QRect(350, 460, 311, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.jin_huo_table.setGeometry(QtCore.QRect(350, 190, 311, 261))
    ...
    def retranslateUi(self, win_jinhuo):
        ...
        self.hint_jin_huo_table.setText(_translate("win_jinhuo", "进货单"))
        ...
        item.setText(_translate("win_jinhuo", "数量"))
