...
class Ui_win_xiaoshou(object):
    def setupUi(self, win_xiaoshou):
        ...
        self.xiaoshou_table.setGeometry(QtCore.QRect(350, 60, 321, 331))
        ...
        self.xiaoshou_table_addrow_btn = QtWidgets.QPushButton(win_xiaoshou)
        self.xiaoshou_table_addrow_btn.setGeometry(QtCore.QRect(350, 400, 321, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.xiaoshou_table_addrow_btn.setFont(font)
        self.xiaoshou_table_addrow_btn.setAutoDefault(False)
        self.xiaoshou_table_addrow_btn.setObjectName("xiaoshou_table_addrow_btn")
        self.xiaoshou_table_removerow_btn = QtWidgets.QPushButton(win_xiaoshou)
        self.xiaoshou_table_removerow_btn.setGeometry(QtCore.QRect(350, 440, 321, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.xiaoshou_table_removerow_btn.setFont(font)
        self.xiaoshou_table_removerow_btn.setAutoDefault(False)
        self.xiaoshou_table_removerow_btn.setObjectName("xiaoshou_table_removerow_btn")
    ...
    def retranslateUi(self, win_xiaoshou):
        ...
        self.xiaoshou_table_addrow_btn.setText(_translate("win_xiaoshou", "添加行"))
        self.xiaoshou_table_removerow_btn.setText(_translate("win_xiaoshou", "删除行"))
